...
def send_success_notification(to_email, from_email, smtp_user, smtp_pass, log_file, duration, summary, health_status="", validation_report_content=""):
...
def main():
    ...
    if notification_type == "success":
        ...
        # Get health status and validation report content
        health_status = sys.argv[11] if len(sys.argv) > 11 else ""
        validation_report_content = sys.argv[12] if len(sys.argv) > 12 else ""
        
        success = send_success_notification(to_email, from_email, smtp_user, smtp_pass, log_file, duration, summary, health_status, validation_report_content)
