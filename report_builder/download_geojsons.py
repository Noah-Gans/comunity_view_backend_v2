...
def download_geojsons_from_gcs(bucket_name="your-bucket-name", local_dir="../PMTiles_Cycle/geojsons_for_db_upload"):
...
if __name__ == "__main__":
    ...
    parser.add_argument("--dir", default="../PMTiles_Cycle/geojsons_for_db_upload", help="Local directory")
